...
<img width="100%" src="https://capsule-render.vercel.app/api?type=waving&color=gradient&customColorList=24,14,20,6,11&height=280&section=header&text=Tanya%20Panchal&fontSize=80&fontColor=fff&animation=fadeIn&fontAlignY=38&desc=Full%20Stack%20Developer%20%7C%20Tech%20Enthusiast%20%7C%20Problem%20Solver&descAlignY=55&descSize=22"/>
...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Experience-5%2B%20Years-red?style=for-the-badge" alt="experience" />
</p>
...
const tanya = {
    ...
    passion: "Creating Beautiful & Functional Web Apps ✨",
    code: ["JavaScript", "TypeScript", "Python", "C++", "SQL"],
    technologies: {
        frontEnd: {
            js: ["React", "Next.js", "Redux"],
            css: ["TailwindCSS", "Styled-Components", "SASS"]
        },
        backEnd: {
            js: ["Node.js", "Express"],
    ...
    learning: "Cloud Architecture & Microservices ☁️",
    hobbies: ["Coding 💻", "Reading 📚", "Music 🎵", "Travel ✈️"],
    funFact: "I debug with coffee ☕ and solve problems with creativity! 🎨",
    askMeAbout: ["Web Dev", "Tech", "Design", "Career Advice"],
    reachMe: "tanyapancha65@gmail.com 📧"
};
```
...
<p align="center">
  <img src="https://skillicons.dev/icons?i=react,nextjs,ts,js,nodejs,python,cpp,mongodb,mysql,postgres,redis,tailwind,sass,git,github,docker,vercel,netlify,figma,vscode&perline=10&theme=dark" />
</p>
...
**✨ Key Features:**
- 🗺️ Real-time GPS tracking & route optimization
...
**🔧 Built With:**
`React` `Node.js` `Express` `MongoDB` `Socket.io` `Maps API`
...
![Visitors](https://img.shields.io/badge/Visitors-1000%2B-blue?style=for-the-badge)
...
**🔧 Built With:**
`React` `TailwindCSS` `Framer Motion` `Netlify`
...
<p align="center">
  ...
  <a href="https://twitter.com/tanupanchal26">
    <img src="https://img.shields.io/badge/Twitter-1DA1F2?style=for-the-badge&logo=twitter&logoColor=white" />
  </a>
  <a href="https://dev.to/tanupanchal26">
    <img src="https://img.shields.io/badge/dev.to-0A0A0A?style=for-the-badge&logo=devdotto&logoColor=white" />
  </a>
  <a href="https://www.instagram.com/tanupanchal26/">
...
<p align="center">
  <a href="https://www.buymeacoffee.com/tanupanchal">
...
### 💪 _"Empowering women in tech through code"_ 💜
